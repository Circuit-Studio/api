        ...
        User.remove({}, (err) => {
          chai.request(server)
              ...
              .end((err, res) => {
                ...
                res.body.message.should.contain('Fetched all users.');
        ...
        user.save((err, saved_user) => {
          chai.request(server)
            ...
            .end((err, res) => {
              ...
              res.body.should.have.property('status').eql('Success');
              res.body.should.have.property('message');
              res.body.message.should.contain('Returning found user.');
              res.body.should.have.property('data');
      ...
      it('should return an internal error', (done) => {
        chai.request(server)
            ...
            .end((err, res) => {
              ...
              res.body.should.have.property('message');
              res.body.message.should.contain('Internal error. Please try again.');
              done();
            });
      });
    });
      ...
      it('should return a bad request and message', (done) => {
        chai.request(server)
            ...
            .end((err, res) => {
              ...
              res.body.should.have.property('status').eql('Failed');
              res.body.should.have.property('message');
              res.body.message.should.contain('Could not find user. Please check id and try again.');
              done();
            });
      });
    });
        ...
        user.save((err, saved_user) => {
          chai.request(server)
            ...
            .end((err, res) => {
              ...
              res.body.should.have.property('status').eql('Success');
              res.body.should.have.property('message');
              res.body.message.should.contain('Deleted username.');
              done();
            });
        });
      });
